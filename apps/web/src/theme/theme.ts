...
import type { ColorRange } from './colors';
import { dataDisplayCustomizations } from './dataDisplay';
import { getColorSchemes } from './themePrimitives';

const defaultTheme = createTheme();

export function getTheme(accentColor: ColorRange) {
  return createTheme({
    colorSchemes: getColorSchemes(accentColor),
    cssVariables: {
