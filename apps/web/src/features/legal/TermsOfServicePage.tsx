      ...
      <Page>
        <Container maxWidth="md">
          ...
          <Typography>
            ...
            Zero! We are pleased to provide you with our content and services
            and appreciate your patronage. Before you engage with our website,
            app, or services, we encourage you to read these Terms of Service,
            so you know what to expect when visiting and engaging with our
            various properties.
            <br />
            <br />
            ...
            Agreement (each a "Website"), accessing or using any application
            with an authorized link to this Agreement (“App,” together with the
            ...
            Properties, the "Services"), or clicking on a button or taking
            another action to signify your acceptance of this Agreement, you:
            (1) agree to be bound by this Agreement and any future amendments
            and additions to this Agreement as published through the Services;
            (2) represent you are of legal age in your jurisdiction of residence
            to form a binding contract; and (3) represent that you have the
            authority to enter into this Agreement personally and, if
            applicable, on behalf of any company, organization or other legal
            entity on whose behalf you use the Services. Except as otherwise
            ...
            accessible through our Services are provided by third-party
            companies pursuant to their own separate terms of service
            (“Third-Party Terms”) that differ from ours. By using such
            third-party features and tools, you agree that your relationships
            with the third-party service providers will be governed by the
            ...
            Services at any time, effective upon posting of an updated version
            of this Agreement or any applicable Supplemental Terms on the
            applicable Services. You should regularly review this Agreement.
            ...
            <br />
            <br />
            1.1Registration Data. When applying for or registering an account
            for any of the Services, including, but not limited to, subscribing
            or gaining access to a magazine or other subscription ("Account"),
            you agree to provide accurate, current and complete information (the
            ...
            in Company’s <Link href="/privacy-policy">Privacy Policy</Link>{' '}
            ...
            <br />
            <br />
            2.2Ownership of Your Content. Company does not claim ownership of
            any User Content you make available on the Services ("Your
            Content"). However, when you as a User post or publish Your Content
            on or in the Services, you represent that you have all of the
            necessary rights to grant Company the license set forth in Section
            2.3. Except with respect to Your Content, you agree that you have no
            right or title in or to any other content that appears on or in the
            Services.
            <br />
            <br />
            2.3License to Your Content. Subject to any applicable Account
            settings that you select or license agreement you may be asked to
            agree to when posting or submitting Your Content on or though the
            Services, you grant Company, its agent(s) and supplier(s), and
            anyone else authorized by Company, an irrevocable, non-exclusive,
            perpetual, worldwide, royalty-free right and license to use, copy,
            display, publicly perform, transmit, modify, publish, distribute,
            make derivative works of, sublicense, and otherwise commercially and
            ...
            reverse compile or reverse engineer any part of the Services except
            ...
            we grant the operators of public search engines revocable permission
            to use spiders to copy materials from the Website for the sole
            ...
            <br />
            <br />
            (j) you shall not use the Services in violation of any applicable
            law;
            <br />
            <br />
            ...
            <br />
            <br />
            (m) you shall not attempt to harm our Services or use the Services
            in a manner that could interfere with any party’s use or enjoyment
            of the Services, including but not limited to, by violating or
            ...
            Any unauthorized use of the Services immediately terminates the
            licenses granted by Company pursuant to this Agreement.
            <br />
            <br />
            ...
            YOU AND YOU MAY HAVE OTHER RIGHTS.
            <br />
            <br />
            ...
            infringement should be emailed to hello@openzero.com. Company
            maintains a policy to terminate in appropriate circumstances the
            Service use privileges of all repeat infringers of copyright rights.
            Please Note: The Copyright Agent has no responsibility for and will
            not respond to Usage/Reprint permission requests or
            Subscriber/Customer Service inquiries.
            <br />
            <br />
            ...
            CONFLICT OF LAW OR OTHER PRINCIPLES THAT PROVIDE FOR THE APPLICATION
            OF THE LAW OF ANOTHER JURISDICTION. THE UNITED NATIONS CONVENTION ON
            ...
            San Francisco County, California or federal courts located in
            California.
            <br />
            <br />
            ...
            please email hello@openzero.com.
            <br />
            <br />
